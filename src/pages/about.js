      ...
      <Container>
        ...
        <article className="w-75 mr-auto ml-auto mt-3 pt-2 text-justify">
          ...
          <p className="i-5">
            ...
            past summer I worked as a Software Engineering Intern at Google on
            the YouTube Music Tools team. Two summers ago, I worked as a
            Software Engineer Intern at Capital One on the&nbsp;
            <a
          ...
          {unemployed && (
            <>
              ...
              <p className="unemployed">
                <small>
                  I am{" "}
                  <b>currently looking for New Grad Software Engineer opportunities.</b>!
                  If you like what you <Link to="/projects">see</Link>, you can
                  contact me at{" "}
                  <b>
